 ...
 */
const HistorySidebar = ({ isOpen, onClose, onLoadSession, currentSessionId }) => {
  ...
  return (
    <>
      ...
      <aside
        id="history-sidebar"
        className={`fixed top-0 left-0 h-full w-[280px] sm:w-80 z-50 glass-strong transform transition-transform duration-300 cubic-bezier(0.4, 0, 0.2, 1) ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        } lg:relative lg:translate-x-0 lg:z-0 lg:rounded-[2rem] lg:h-[calc(100vh-120px)] shadow-2xl lg:shadow-none ${isOpen ? '' : 'lg:hidden'}`}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-5 lg:p-6 border-b border-surface-200/50 dark:border-surface-700/30">
        ...
        {/* Session List */}
        <div className="overflow-y-auto h-[calc(100%-80px)] p-3 lg:p-4 space-y-2 pb-20 lg:pb-4">
          {loading && (
